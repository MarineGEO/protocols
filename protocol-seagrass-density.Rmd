---
title: "Seagrass Cover and Density"
output: pdf_document
header-includes:
  \usepackage{wrapfig}
  \usepackage{float}
...
5. If shoot densities cannot be assessed visually OR by touch, a biomass core can be used to destructively sample the bed and count shoot densities in the lab (see: (Seagrass Biomass Core protocol)[https://marinegeo.github.io/modules/seagrass-biomass]).
