---
title: "Protocol: Seagrass Epifauna"
output: pdf_document
header-includes:
  \usepackage{wrapfig}
  \usepackage{float}
...
\underline{How to cite this work:} Protocol: Seagrass Epifauna (`r lubridate::year(Sys.Date())`) Tennenbaum Marine Observatories Network, MarineGEO, Smithsonian Institution.
