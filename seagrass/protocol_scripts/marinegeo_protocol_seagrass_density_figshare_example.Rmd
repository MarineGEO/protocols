---
title: "Protocol: Seagrass Cover and Density"
output: pdf_document
header-includes:
  \usepackage{wrapfig}
  \usepackage{float}
...
\underline{How to cite this work:} Protocol: Seagrass Cover and Density (`r lubridate::year(Sys.Date())`) Tennenbaum Marine Observatories Network, MarineGEO, Smithsonian Institution. https://doi.org/10.25573/serc.123456.v1
