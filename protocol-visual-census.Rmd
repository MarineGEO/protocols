---
title: "Protocol: Diver Visual Survey"
output: pdf_document
header-includes:
  \usepackage{wrapfig}
  \usepackage{caption}
...
\underline{How to cite this work:} Protocol: Diver Visual Survey. (`r lubridate::year(Sys.Date())`) Tennenbaum Marine Observatories Network, MarineGEO, Smithsonian Institution.
