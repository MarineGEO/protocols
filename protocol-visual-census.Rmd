...
header-includes: 
  ...
  \usepackage{fancyhdr}
    ...
    \fancyhead[RO,RE]{Diver Visual Survey}
...
\caption{Swimming animal survey diagram (Method 1).}
\label{fig:subim1}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=0.9\linewidth, height=5cm]{benthic_survey}
\caption{Macroinvertebrate and Cryptic Fish Survey diagram (Method 2).}
\label{fig:subim2}
\end{subfigure}
...
3.	Conduct fish surveys (**Method 1**):
      a.	Visualize a “block” 5-m wide and high 5-m, bordering the transect line (Fig. 1). The two divers in a pair will each swim and record from a 5-x-5 m block along different sides of the transect line;
...
4.	Conduct separate mobile macroinvertebrate and cryptic fish surveys (**Method 2**):
      a.	Using the same transect line censused with Method 1, visualize a block 1-m wide and 2-m high with the transect line on one edge. (Fig. 2);
      b.	Swim the block;
...
\begin{wrapfigure}{r}{0.4\textwidth}
  \begin{center}
    \includegraphics[width=0.4\textwidth]{pelagic_survey}
  \end{center}
  \vspace{-10mm}
  \caption{Swimming animal survey diagram (Method 1).}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.5\textwidth}
  \begin{center}
    \includegraphics[width=0.5\textwidth]{benthic_survey}
  \end{center}
  \vspace{-10mm}
  \caption{Macroinvertebrate and Cryptic Fish Survey diagram (Method 2).}
\end{wrapfigure}
