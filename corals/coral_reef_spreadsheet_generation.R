...
coral_reef_schema <- read_csv("./corals/coral_reef_schema.csv")

doi <- paste0("DOI: ", "10.25573/serc.14714175.v1")
...
#     
#     protocol_schema <- coral_reef_schema %>%
#       filter(protocol_name == protocol,
#              sheet_name == table)
#     
...
#   }
#   
#   filename = paste0("./corals/final_spreadsheets/", protocol, "_marinegeo_protocol.xlsx")
#   
